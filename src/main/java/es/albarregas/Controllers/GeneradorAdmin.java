 ...
 * @author Antonio
 */
@WebServlet(name = "GeneradorAdmin", urlPatterns = {"/GeneradorAdmin"})
public class GeneradorAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("usuarios")!=null){
            ArrayList<Usuarios> usuarios = usersDao.getAllUsers();
